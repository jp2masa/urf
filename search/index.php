<html>
	<head>
		<title><?php echo $summonerName?> U.R.F. Matches Search</title>
...
<?php
	...
	for($match = 0; $match <= 9; $match++)
	{
		if($result["games"][$match]["subType"] == "URF")
		{
			...
			{
				$cs[$participant["teamId"]][$participant["championId"]] = $participant["stats"]["minionsKilled"];
				...
				$lastSeasonTier[$participant["teamId"]][$participant["championId"]] = $participant["highestAchievedSeasonTier"];
...
?>
				<tr class="player">
					<td><img class="summonerIcon" src="../img/champions/<?php echo $championKey?>.png" title="<?php echo $championName?>"></img></td>
					<td <?php if($summonerBlue == 0 && $isBlue) echo("style=\"font-weight: bold\"")?>>
						<span class="summonerName" title="&lt;p class=&quot;lastSeasonTitle&quot;&gt;Last Season Tier:&lt;/p&gt;&lt;img class=&quot;tierImage&quot; src=&quot;../img/tier/<?php echo $lastSeasonTier[100][$championId];?>.png&quot;/&gt;"><?php echo htmlentities($blueSummoners[$summonerBlue], 0, 'UTF-8')?></span>
					<td><div class="spells">
					...
					<td><span><?php print $cs[100][$championId]?></span></td>
				</tr>
				<script>
$('.summonerIcon').tooltipster();
$('.summonerName').tooltipster({
	contentAsHTML: true
});
				</script>
<?php
...
?>
				<tr class="player">
					<td><span><?php print $cs[200][$championId]?></span></td>
					...
					<td <?php if($summonerRed == 0 && !$isBlue) echo("style=\"font-weight: bold\"")?>>
						<span class="summonerName" title="&lt;p class=&quot;lastSeasonTitle&quot;&gt;Last Season Tier:&lt;/p&gt;&lt;img class=&quot;tierImage&quot; src=&quot;../img/tier/<?php echo $lastSeasonTier[200][$championId];?>.png&quot;/&gt;"><?php echo htmlentities($redSummoners[$summonerRed], 0, 'UTF-8')?></span>
					</td>
					<td><img class="summonerIcon" src="../img/champions/<?php echo $championKey?>.png" title="<?php echo $championName?>"></img></td>
				</tr>
				<script>
...
<?php
	...
	if(!$hasGames)
		print("<div class=\"nomatches\">No Recent U.R.F. Matches Found!</div>");
